package com.ly.shoppingcart.view;
...
import com.ly.shoppingcart.utils.DensityUtils;
...
public class CustomTitleBarView extends RelativeLayout {
	...
	public interface onBarViewClickListener{
		void onBarViewClick(View v,int witch);
	}
	...
	private void initEvent(final View leftView, final View rightView) {
		if (leftView != null) {
			leftView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (mListener != null) {
						mListener.onBarViewClick(leftView, -1);
					}
		...
		if (rightView != null) {
			rightView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if (mListener != null) {
						mListener.onBarViewClick(leftView, -2);
					}
